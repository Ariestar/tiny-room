		...
		<div className='bg-background/80 border-b border-border sticky top-0 z-50 backdrop-blur-sm'>
			<div className='container mx-auto px-6 py-4'>
				<div className='flex items-center justify-between'>
					<a
						href='/ui-showcase'
						className='flex items-center text-foreground hover:text-primary font-semibold text-lg no-underline transition-colors duration-200'
					>
						<svg
					...
					{/* 移动端菜单按钮 */}
					<button className='md:hidden p-2 text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-colors duration-200'>
						<svg
							className='w-5 h-5'
							fill='none'
							stroke='currentColor'
