...
export { ParallaxBackground } from "./ParallaxBackground"; // <-- 添加了这一行
...
// 工具函数：获取磁吸强度
export function getMagneticStrength(context: "gallery" | "blog" | "default"): number {
...
// 工具函数：计算动画延迟
export function getAnimationDelay(index: number, baseDelay: number = 0.3): number {
