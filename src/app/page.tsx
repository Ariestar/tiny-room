			...
			<section className='relative overflow-hidden'>
				...
				<div className='relative max-w-7xl mx-auto px-6 py-24'>
					...
					<div className='text-center animate-fade-in'>
						<div className='inline-flex items-center px-4 py-2 rounded-full bg-brand-50 border border-brand-200 text-brand-700 font-medium text-sm mb-8 animate-slide-down'>
							<span className='w-2 h-2 bg-brand-500 rounded-full mr-2 animate-pulse'></span>
							现代化设计系统已启用
						</div>

						<h1 className='text-6xl md:text-7xl font-bold bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text text-transparent mb-6 animate-slide-up font-display'>
							Tiny Room
						</h1>

						<p
							className='text-xl text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed animate-slide-up'
						...
						>
							<a
								href='/ui-showcase'
								className='group px-8 py-4 bg-brand-500 hover:bg-brand-600 text-white rounded-2xl font-semibold transition-all duration-300 shadow-soft hover:shadow-medium animate-button-press active:animate-button-press no-underline'
							>
							...
							<button className='px-8 py-4 border-2 border-gray-200 hover:border-gray-300 text-gray-700 hover:text-gray-900 rounded-2xl font-semibold transition-all duration-300 hover:bg-gray-50'>
								开始探索
							</button>
						</div>
					</div>
